...
<body>
  ...
  <p>You have learned the basics! Now you get to pick which project you want to try for.</p></br>
  <p>There are two choices: a bag or a blanket.</p></br>
  <a class="btn-bag" href="circle.php" role="button">Bag</a>
  <a class="btn-blanket" href="smallBlanket.php" role="button">Blanket</a>
</body>
</html>
