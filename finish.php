...
<body>
  ...
  <p>Congratulations! You finished your first project. You now know the basics of crocheting. You can either go check out the other project
    or go check out Ravelry.com and see what else you can make!</p></br>
  <p>If you want to go try the other project click below.</p></br>
  <a class="btn-fin" href="decision.php" role="button">Go Back</a>
</body>
</html>
