...
<body>
  ...
  <dl>
    <dt>Bowl</dt>
    <dd>Creating a bowl might seem boring and kind pointless but it is just to get
      you use to the idea of working in 3-D and how it can differ from working in 2-D.
    </dd>
  </dl>
  ...
  <dl>
    <dd>Stuff about how to do this!!
    </dd>
  </dl>
  <a href="2d.php" class="previous">&laquo;
    Previous</a>
  <a href="bag.php" class="next">Next &raquo;</a>
</body>
</html>
