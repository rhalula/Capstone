...
<body>
  ...
  <dl>
    <dt>Bag</dt>
    <dd>Creating a bag can be a pretty good point. It means that you understand and
      are able to the basics and have a grasp on working in 3-D.
    </dd>
  </dl>
  ...
  <a href="bowl.php" class="previous">&laquo;
    Previous</a>
